...
const ThirdPartyLogin = () => {
    return (
        <>
            <div className="flex justify-center items-center card-body card-bordered border-gray-300 rounded-box">
                <div className="text-center text-2xl font-semibold text-white-700">
                    Third Party Login
                    <Divider />
                </div>
