...
*/}
            ...
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
                <div className="mx-auto max-w-lg rounded-box border-2 border-gray-500">
                    {/* <h1 className="text-center text-2xl font-bold text-gray-600 sm:text-3xl">Get started today</h1> */}

                    <form
                        onSubmit={handleSubmit(onSubmit)}
                        className="w-150 mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8"
                    >
